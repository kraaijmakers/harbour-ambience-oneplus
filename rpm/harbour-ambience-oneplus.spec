Name:       harbour-ambience-oneplus

Summary:    Never Settle Ambience
Version:    0.1.2
Release:    0.3
...
Vendor: Kevin Raaijmakers
Packager: Kevin Raaijmakers <kraaijmakers@outlook.com>

# This requirement is verboten for Harbour submission
Requires:   ambienced

%description
The Never Settle ambience for OnePlus One device.
